...
public class Stock extends Investment{
    ...
    */
    ...
    /**
     * This method will set the current of value
     * of the symbol to the string value passed in
     *
     * @param symbol - value to set stock's symbol
     */
    ...
    /**
     * This method will set the current of value 
     * of the name to the string value passed in
     *
     * @param name - value to set stock's name
     */
    ...
    /**
     * This method will set the current of value 
     * of the quantity to the int value passed in
     *
     * @param quantity - value to set stock's quantity
     */
    ...
    /**
     * This method will set the current of value of the 
     * price to the double value passed in
     *
     * @param price - value to set stock's price
     */
    ...
    /**
     * This method will return the current value of the 
     * stock's book value
     *
    ...
    /**
     * This method will set the current of value of the 
     * bookValue to the double value passed in
     *
     * @param bookValue - value to set stock's bookValue
     */
